...
export const CLASS_REGISTRY: ClassDefinition[] = [
  ...
  },
  {
    ...
    source: "Player's Handbook",
    subclasses: [
      { id: 'life', name: 'Домен Жизни', description: 'Непревзойдённый целитель, благословлённый силой исцеления.', source: 'PHB', level: 1 },
      { id: 'light', name: 'Домен Света', description: 'Несёт свет и огонь, изгоняя тьму.', source: 'PHB', level: 1 },
      { id: 'tempest', name: 'Домен Бури', description: 'Повелевает грозами и разрушительными стихиями.', source: 'PHB', level: 1 },
      { id: 'war', name: 'Домен Войны', description: 'Воитель веры, благословлённый на битву.', source: 'PHB', level: 1 },
      { id: 'knowledge', name: 'Домен Знаний', description: 'Хранитель тайного знания и мудрости.', source: 'PHB', level: 1 },
      { id: 'trickery', name: 'Домен Обмана', description: 'Агент хаоса, мастер иллюзий и хитрости.', source: 'PHB', level: 1 },
      { id: 'forge', name: 'Домен Кузни', description: 'Мастер огня и металла, создатель магических предметов.', source: "Xanathar's Guide", level: 1 },
      { id: 'grave', name: 'Домен Могилы', description: 'Страж границы между жизнью и смертью.', source: "Xanathar's Guide", level: 1 },
    ],
    proficiencies: {
      armor: ['Лёгкие доспехи', 'Средние доспехи', 'Щиты'],
  ...
  },
  {
    ...
    source: "Player's Handbook",
    subclasses: [
      { id: 'land', name: 'Круг Земли', description: 'Мистик, связанный с определённой местностью.', source: 'PHB', level: 2 },
      { id: 'moon', name: 'Круг Луны', description: 'Мастер дикого облика, способный обращаться в могучих зверей.', source: 'PHB', level: 2 },
      { id: 'shepherd', name: 'Круг Пастыря', description: 'Призыватель духов природы и защитник животных.', source: "Xanathar's Guide", level: 2 },
      { id: 'spores', name: 'Круг Спор', description: 'Повелевает силами разложения и возрождения.', source: "Tasha's Cauldron", level: 2 },
    ],
    proficiencies: {
  ...
  },
  {
    ...
    source: "Player's Handbook",
    subclasses: [
      { id: 'draconic', name: 'Драконья Кровь', description: 'Магия древних драконов течёт в ваших жилах.', source: 'PHB', level: 1 },
      { id: 'wild-magic', name: 'Дикая Магия', description: 'Хаотическая сила, непредсказуемая и разрушительная.', source: 'PHB', level: 1 },
      { id: 'divine-soul', name: 'Божественная Душа', description: 'Божественная искра даёт доступ к жреческим заклинаниям.', source: "Xanathar's Guide", level: 1 },
      { id: 'shadow', name: 'Теневая Магия', description: 'Связь с Царством Теней наделяет тёмной силой.', source: "Xanathar's Guide", level: 1 },
      { id: 'aberrant-mind', name: 'Аберрантный Разум', description: 'Псионическая сила из контакта с чуждыми сущностями.', source: "Tasha's Cauldron", level: 1 },
      { id: 'clockwork-soul', name: 'Заводная Душа', description: 'Сила порядка Механуса течёт через вас.', source: "Tasha's Cauldron", level: 1 },
    ],
    proficiencies: {
      armor: [],
  ...
  },
  {
    ...
    source: "Player's Handbook",
    subclasses: [
      { id: 'archfey', name: 'Архифея', description: 'Покровитель из Страны Фей с чарующей магией.', source: 'PHB', level: 1 },
      { id: 'fiend', name: 'Исчадие', description: 'Пакт с демоном или дьяволом, дающий разрушительную силу.', source: 'PHB', level: 1 },
      { id: 'great-old-one', name: 'Великий Древний', description: 'Контакт с непостижимой сущностью из глубин космоса.', source: 'PHB', level: 1 },
      { id: 'celestial', name: 'Небожитель', description: 'Покровитель из верхних планов, дающий целительную силу.', source: "Xanathar's Guide", level: 1 },
      { id: 'hexblade', name: 'Ведьмин Клинок', description: 'Пакт с таинственным оружием из Царства Теней.', source: "Xanathar's Guide", level: 1 },
      { id: 'fathomless', name: 'Бездонный', description: 'Покровитель из глубин океана с тёмной водной магией.', source: "Tasha's Cauldron", level: 1 },
    ],
    proficiencies: {
      armor: ['Лёгкие доспехи'],
      weapons: ['Простое оружие'],
  ...
  },
  {
    ...
    source: "Player's Handbook",
    subclasses: [
      { id: 'abjuration', name: 'Школа Ограждения', description: 'Мастер защитной магии и магических барьеров.', source: 'PHB', level: 2 },
      { id: 'conjuration', name: 'Школа Вызова', description: 'Призывает существ и создаёт предметы из ничего.', source: 'PHB', level: 2 },
      { id: 'divination', name: 'Школа Прорицания', description: 'Видит будущее и управляет вероятностями.', source: 'PHB', level: 2 },
      { id: 'enchantment', name: 'Школа Очарования', description: 'Управляет разумом и эмоциями.', source: 'PHB', level: 2 },
      { id: 'evocation', name: 'Школа Воплощения', description: 'Мастер разрушительной стихийной магии.', source: 'PHB', level: 2 },
      { id: 'illusion', name: 'Школа Иллюзий', description: 'Создаёт обманчивые образы и искажает реальность.', source: 'PHB', level: 2 },
      { id: 'necromancy', name: 'Школа Некромантии', description: 'Управляет силами жизни и смерти.', source: 'PHB', level: 2 },
      { id: 'transmutation', name: 'Школа Преобразования', description: 'Изменяет свойства материи и энергии.', source: 'PHB', level: 2 },
      { id: 'war-magic', name: 'Школа Военной Магии', description: 'Сочетает атакующую и защитную магию в бою.', source: "Xanathar's Guide", level: 2 },
      { id: 'chronurgy', name: 'Хронургия', description: 'Манипулирует временем и вероятностями.', source: "Explorer's Guide to Wildemount", level: 2 },
    ],
    proficiencies: {
      armor: [],
      weapons: ['Кинжалы', 'Дротики', 'Пращи', 'Боевые посохи', 'Лёгкие арбалеты'],
