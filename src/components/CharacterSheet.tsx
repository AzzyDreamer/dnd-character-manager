...
import { getSpellByName, SCHOOL_NAMES, type SpellData } from '../data/spells';
...
// ─── Вкладка Заклинания ───
const SpellsTab: React.FC<{ character: Character }> = ({ character }) => {
